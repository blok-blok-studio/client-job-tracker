...
export async function GET(
  ...
  const client = await prisma.client.findUnique({
    ...
    include: {
      ...
      paymentLinks: { orderBy: { createdAt: "desc" }, select: { id: true, stripeUrl: true, amount: true, description: true, recurring: true, interval: true, status: true, paidAt: true, createdAt: true } },
    },
  });
